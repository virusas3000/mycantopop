...
TODAY = datetime.date.today().isoformat()  # 2026-08-23
TODAY_DISPLAY = "2026年08月23日"

# 29 unique long-tail topics: (slug, title, description, category, body_paragraphs)
ARTICLES = [
("cantonese-song-melody-retrograde-inversion-canonical-technique",
 "廣東歌旋律逆行倒影卡農技巧：點樣用對位法豐富旋律層次",
 "旋律逆行倒影同卡農技法豐富廣東歌旋律層次。教你用對位法寫出更有深度嘅主旋律。",
 "作曲編曲",
 []),
("cantopop-mixing-vocal-harmony-eq-carving-frequency-separation-guide",
 "廣東歌混音和聲頻率雕刻分離指南：點樣用EQ令和音唔遮主唱",
 "和聲頻率雕刻分離主唱同和音。教你用EQ carving技巧混音廣東歌和聲層。",
 "錄音製作",
 []),
("cantonese-lyrics-writing-from-historical-photograph-narrative-technique",
 "粵語歌詞從歷史照片敘事寫作技巧：點樣用舊相片激發創作靈感",
 "歷史照片激發歌詞敘事靈感。教你從舊相片中提取情感寫粵語歌詞。",
 "填詞技巧",
 []),
("cantopop-arrangement-string-quartet-divisi-voicing-technique-guide",
 "廣東歌編曲弦樂四重奏Divisi聲部技巧：點樣用Divisi豐富弦樂織體",
 "弦樂四重奏Dividi聲部技巧豐富編曲織體。教你用Divisi寫廣東歌弦樂。",
 "作曲編曲",
 []),
("cantonese-song-vocal-recording-ribbon-mic-ribbon-preamp-pairing-guide",
 "廣東歌人聲錄音Ribbon麥克風配搭前置放大器指南：點樣揀溫暖音色組合",
 "Ribbon麥克風配搭前置放大器錄出溫暖人聲。教你揀廣東歌錄音組合。",
 "錄音製作",
 []),
("cantopop-mastering-mid-side-eq-stereo-width-control-technique-guide",
 "廣東歌母帶Mid-Side EQ立體聲寬度控制技巧：點樣用M/S處理拓闊音場",
 "Mid-Side EQ控制立體聲寬度。教你用M/S處理做廣東歌母帶拓闊音場。",
 "錄音製作",
 []),
("cantonese-lyrics-writing-from-sense-of-taste-gustatory-memory-technique",
 "粵語歌詞從味覺記憶寫作技巧：點樣用味道喚起情感共鳴",
 "味覺記憶喚起歌詞情感共鳴。教你從味道出發寫粵語歌詞。",
 "填詞技巧",
 []),
("cantopop-arrangement-synth-pad-modulation-movement-technique-guide",
 "廣東歌編曲合成器Pad調制動態技巧：點樣用LFO同Envelop令Pad有生命",
 "合成器Pad調制LFO同Envelope令音色有動態生命。教你編曲廣東歌Pad層。",
 "作曲編曲",
 []),
("cantonese-song-distribution-apple-music-lossless-delivery-guide",
 "廣東歌發行Apple Music無損音質交付指南：點樣準備Hi-Res Lossless母帶",
 "Apple Music無損音質Hi-Res Lossless母帶準備。教你發行廣東歌到Apple Music。",
 "發行推廣",
 []),
("cantopop-vocal-recording-iphone-usb-c-mic-adapter-setup-guide",
 "廣東歌人聲錄音iPhone USB-C麥克風轉接器設定指南：手機錄音專業化",
 "iPhone USB-C麥克風轉接器手機錄音專業化。教你用iPhone錄廣東歌人聲。",
 "錄音製作",
 []),
("cantonese-lyrics-writing-from-bus-route-journey-narrative-technique",
 "粵語歌詞從巴士路線旅程敘事寫作技巧：點樣用公共交通寫城市故事",
 "巴士路線旅程激發城市敘事歌詞。教你從公共交通寫粵語歌詞故事。",
 "填詞技巧",
 []),
("cantopop-mixing-drum-parallel-saturation-warmth-technique-guide",
 "廣東歌混音鼓組並聯飽和溫暖感技巧：點樣用Saturation令鼓聲更厚",
 "鼓組並聯飽和Saturation令鼓聲更厚更溫暖。教你混音廣東歌鼓組。",
 "錄音製作",
 []),
("cantonese-song-melody-sequence-transposition-modulatory-technique",
 "廣東歌旋律模進轉調移位技巧：點樣用Sequence Modulation推進旋律",
 "旋律模進轉調移位Sequence Modulation推進旋律發展。教你寫廣東歌旋律。",
 "作曲編曲",
 []),
("cantopop-arrangement-guitar-pedal-steel-bend-glissando-technique-guide",
 "廣東歌編曲結他Pedal Steel彎音滑奏技巧：點樣用Glissando製造鄉愁感",
 "結他Pedal Steel彎音滑奏Glissando製造鄉愁感。教你編曲廣東歌結他層。",
 "作曲編曲",
 []),
("cantonese-song-distribution-tidal-masters-mqa-delivery-guide",
 "廣東歌發行Tidal Masters MQA交付指南：點樣準備MQA格式母帶",
 "Tidal Masters MQA格式母帶準備。教你發行廣東歌到Tidal高音質平台。",
 "發行推廣",
 []),
("cantopop-vocal-pitch-correction-formant-preserve-natural-tone-guide",
 "廣東歌人聲音高校正Formant保留自然音色指南：點樣修音唔似機械人",
 "音高校正Formant保留自然音色。教你用Pitch Correction修廣東歌人聲。",
 "錄音製作",
 []),
("cantonese-lyrics-writing-from-overheard-phone-conversation-fragment-technique",
 "粵語歌詞從偷聽電話對話片段寫作技巧：點樣用日常對話激發靈感",
 "偷聽電話對話片段激發歌詞靈感。教你從日常對話寫粵語歌詞。",
 "填詞技巧",
 []),
("cantopop-mixing-bass-sub-frequency-enhancement-multiband-technique-guide",
 "廣東歌混音貝斯超低頻增強多段技巧：點樣用Multiband令低頻更飽滿",
 "貝斯超低頻增強Multiband令低頻更飽滿。教你混音廣東歌貝斯層。",
 "錄音製作",
 []),
("cantonese-song-melody-neighbor-tone-ornamentation-grace-note-technique",
 "廣東歌旋律鄰音裝飾倚音技巧：點樣用Grace Note令旋律更細膩",
 "鄰音裝飾Grace Note令旋律更細膩。教你用裝飾音寫廣東歌旋律。",
 "作曲編曲",
 []),
("cantopop-arrangement-percussion-shaker-egg-layer-groove-enhancement-guide",
 "廣東歌編曲打擊樂沙錘蛋層律動增強指南：點樣用Shaker填補節奏空隙",
 "沙錘蛋Shaker填補節奏空隙增強律動。教你編曲廣東歌打擊層。",
 "作曲編曲",
 []),
("cantonese-song-distribution-bandcamp-friday-revenue-strategy-guide",
 "廣東歌發行Bandcamp Friday收益策略指南：點樣用月度活動最大化收入",
 "Bandcamp Friday月度活動最大化獨立音樂收入。教你發行廣東歌到Bandcamp。",
 "發行推廣",
 []),
("cantopop-vocal-harmony-arrangement-cluster-voicing-close-harmony-guide",
 "廣東歌和聲編曲Cluster Voicing密集和聲指南：點樣用音簇製造張力",
 "Cluster Voicing密集和聲音簇製造張力。教你編曲廣東歌和聲層。",
 "作曲編曲",
 []),
("cantonese-lyrics-writing-from-grandparent-life-story-narrative-technique",
 "粵語歌詞從祖父母生平故事敘事寫作技巧：點樣用家族歷史寫感動歌詞",
 "祖父母生平故事激發家族歷史歌詞。教你從長輩經歷寫粵語歌詞。",
 "填詞技巧",
 []),
("cantopop-mixing-vocal-reverb-pre-delay-emotional-space-technique-guide",
 "廣東歌混音人聲Reverb Pre-Delay情感空間技巧：點樣用預延遲控制距離感",
 "Reverb Pre-Delay預延遲控制人聲情感空間距離感。教你混音廣東歌人聲。",
 "錄音製作",
 []),
("cantonese-song-melody-passing-tone-chromatic-suspension-technique-guide",
 "廣東歌旋律經過音半音掛留技巧：點樣用Chromatic Suspension製造緊張感",
 "經過音半音掛留Chromatic Suspension製造旋律緊張感。教你寫廣東歌旋律。",
 "作曲編曲",
 []),
("cantopop-arrangement-brass-section-muted-cup-warm-tone-technique-guide",
 "廣東歌編曲銅管段落Cup Mute溫暖音色技巧：點樣用弱音器改變銅管性格",
 "銅管Cup Mute弱音器改變音色性格。教你編曲廣東歌銅管段落。",
 "作曲編曲",
 []),
("cantonese-song-distribution-soundcloud-monetization-premium-guide",
 "廣東歌發行SoundCloud monetization Premium收益指南：點樣喺平台賺錢",
 "SoundCloud Monetization Premium平台賺錢策略。教你發行廣東歌到SoundCloud。",
 "發行推廣",
 []),
("cantopop-vocal-recording-large-diaphragm-condenser-sweet-spot-guide",
 "廣東歌人聲錄音大震膜電容麥克風Sweet Spot尋找指南：點樣揀最佳距離角度",
 "大震膜電容麥克風Sweet Spot最佳距離角度。教你錄廣東歌人聲。",
 "錄音製作",
 []),
("cantopop-indie-musician-house-concert-intimate-venue-organization-guide",
 "獨立廣東歌音樂人House Concert私人場地組織指南：點樣搞屋企音樂會",
 "House Concert私人場地屋企音樂會組織。教你做獨立廣東歌音樂人演出。",
 "發行推廣",
 []),
]
...
for slug, title, desc, cat, _ in ARTICLES:
...
commit_msg = f"feat: daily SEO batch — 29 new articles on 廣東歌制作, 作曲, 編曲, 錄音, 混音, 發行"
